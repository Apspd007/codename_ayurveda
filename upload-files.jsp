...
<body>
 <section class="lg:hidden flex flex-col w-full bg-white border-b gap-y-4">
        ...
        <!-- Logo and navigation -->
       <div onclick="openMenu()" class="border-t py-2 pr-10 text-end">Menu</div>
        <div id="mob-menu" class="hidden flex justify-center bg-white items-end">
            <nav class="flex flex-col w-min items-center self-end justify-end gap-x-7 py-1 pl-14 px-10">
                <div
                ...
                <div>
                    ...
                    <div id="menu-item-about" class="hidden peer-hover:grid hover:grid grid-flow-row
                     bg-white drop-shadow-lg absolute z-10">
                        ...
                        <a class="px-5 py-3 hover:bg-gray-200" href="https://www.education.gov.in/about-moe">About
                            MOE</a>
  ...
  <!-- Logo and navigation -->
    ...
    <div class="container" style="margin-top: 25px; background-color: aliceblue;">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                <svg aria-hidden="true" class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Add Data</span>
                </div>
            </li>
            </ol>
        </nav>
